...
(function(module) {
  ...
  // This method is invoked in book-view.js inside of the bookView.initSearchFormPage function. "book" is an object that assigns the key value pairs for creating a book. The  callback that will be invoked after Book.loadAll is invoked is bookView.initSearchResultsPage.
  ...
  // It is invoked in the bookView.initSearchResultsPage function. It is 'getting' by ISBN number. This is different from Book.find because it is not loading all books but creating a new book from the API endpoint.  
  Book.findOne = isbn =>
